...
const Allowance = () => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      const response = await makeRequest("/api/kids/transactions/allowance", {
        method: "POST",    
      ...
      <div className="w-full max-w-md bg-white shadow-md rounded-lg p-6">
        ...
        {message.showMessage ? (
          <div className="text-center">
            ...
            <button className="btn btn-sm bg-[rgb(90,191,249)] text-white" onClick={() => setMessage({showMessage: false})}>Perform another action</button>
          </div>
        ) : (
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                type="number"
                placeholder="Enter amount in eth (0.00023)"
